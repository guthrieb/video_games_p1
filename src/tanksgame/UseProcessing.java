...
//    	tanks[1] = new Tank(SCREEN_WIDTH - tankEdgeMargin, SCREEN_HEIGHT - floorHeight, (float) Math.PI);
//    }
//    
...
//    		ellipseMode(CENTER);
//    		fill(100);
//    		ellipse(tank.getXpos() + tankWidth/2, tank.getYpos() + tankHeight/2, 10, 10);
//    		
//    		lineAngle(tank.getXpos() + tankWidth/2, tank.getYpos() + tankHeight/2, tank.getFiringAngle(), barrelLength);
//    	}
//    }
//    
//    private void lineAngle(float f, float g, float angle, float length) {
//    	line(f, g, f + cos((float) angle)*length, g - sin((float) angle)*length);
//    }
//
//}
